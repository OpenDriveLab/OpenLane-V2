...
class Collection:
    ...
    """
    def __init__(self, root_path : str, collection : str) -> None:
        r"""
        Parameters
        ----------
        root_path : str
