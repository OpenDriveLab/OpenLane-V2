...
THRESHOLDS_FRECHET = [0.5, 1.0, 1.5]
THRESHOLDS_IOU = [0.75]
...
def evaluate(ground_truth, predictions):
    ...
    metrics['OpenLane-V2 Score']['mAP_LC'] = _mAP_over_threshold(
        gts=gts, 
        preds=preds, 
    ...
    metrics['OpenLane-V2 Score']['mAP_TE'] = np.hstack([_mAP_over_threshold(
        gts=gts, 
        preds=preds, 
    ...
    metrics['OpenLane-V2 Score']['mAP_LCLC'] = _mAP_topology_lclc(gts, preds, THRESHOLDS_FRECHET)
    metrics['OpenLane-V2 Score']['mAP_LCTE'] = _mAP_topology_lcte(
        gts,
        preds,
        {'lane_centerline': THRESHOLDS_FRECHET, 'traffic_element': THRESHOLDS_IOU},
    )

    metrics['OpenLane-V2 Score']['score'] = np.asarray(list(metrics['OpenLane-V2 Score'].values())).mean()
